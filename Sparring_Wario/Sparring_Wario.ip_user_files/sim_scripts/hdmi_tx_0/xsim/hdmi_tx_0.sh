...
#
# Script generated by Vivado on Mon Mar 17 22:52:01 -0400 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot hdmi_tx_0 xil_defaultlib.hdmi_tx_0 -log elaborate.log
}
