...
#
# Script generated by Vivado on Wed Apr 16 05:53:18 -0400 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : audio_rom.sh
...
#
# Usage        : audio_rom.sh
#                audio_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                audio_rom.sh [-reset_run]
#                audio_rom.sh [-reset_log]
#                audio_rom.sh [-help]
#
...
#                script (type 'audio_rom.sh -help' for more information).
#
...
# script info
echo -e "audio_rom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./audio_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.audio_rom xil_defaultlib.glbl -o audio_rom_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./audio_rom_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key audio_rom_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc audio_rom_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./audio_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: audio_rom.sh [-help]\n\
Usage: audio_rom.sh [-step]\n\
Usage: audio_rom.sh [-lib_map_path]\n\
Usage: audio_rom.sh [-reset_run]\n\
Usage: audio_rom.sh [-reset_log]\n\
Usage: audio_rom.sh [-keep_index]\n\
Usage: audio_rom.sh [-noclean_files]\n\n\
