...
HD_PWD='E:/Projects/FPGA/Sparring_Wario_Game/Sparring_Wario/Sparring_Wario.runs/audio_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_rom.tcl
