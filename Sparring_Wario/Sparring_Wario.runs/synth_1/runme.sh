...
HD_PWD='E:/Projects/FPGA/Sparring_Wario_Game/Sparring_Wario/Sparring_Wario.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_To_HDMI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_To_HDMI.tcl
